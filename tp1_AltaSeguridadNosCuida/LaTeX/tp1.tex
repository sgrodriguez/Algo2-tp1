...
\tadUsa{\tadNombre{Nat, Conj($\alpha$), Bool, Tupla($\alpha_1, \ldots, \alpha_n$), Multiconj($\alpha$), id, placa, est, campus, direccion, \\ SituacionesRodeo, TipoElem}}
...
\tadAxioma{campus? (nuevaUni($c, as$))}{$c$\\}
